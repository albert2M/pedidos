module.exports = (app) => { //Exporto una función a la que le paso como parámetro "app"
    ...
    const controller = require('../controllers/admin/contact-controller.js') //En la constante "controller" cargo el archivo "user-controller.js"
  ...
  //Las cuatro lineas anteriores serían los endpoints
    app.use('/api/admin/contacts', router) // Hey app! Usa esta url básica, con los anteriores endpoints ("roter")
  }

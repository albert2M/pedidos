module.exports = (app) => { // Exporto una función a la que le paso como parámetro "app"
  ...
  const controller = require('../controllers/admin/customer-controller.js') // En la constante "controller" cargo el archivo "user-controller.js"
  ...
  app.use('/api/admin/customers', router) // Hey app! Usa esta url básica, con los anteriores endpoints ("roter")
}

module.exports = (app) => { //Exporto una función a la que le paso como parámetro "app"
    ...
    const controller = require('../controllers/admin/fingerprint-controller.js') //En la constante "controller" cargo el archivo "user-controller.js"
  ...
  //Las cuatro lineas anteriores serían los endpoints
    app.use('/api/admin/fingerprints', router) // Hey app! Usa esta url básica, con los anteriores endpoints ("roter")
  }

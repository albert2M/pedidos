        ...
        <div class="filter-modal">
          <form class="filter-form">
            <div class="form-group">
              <label for="filter-name">Nombre comercial:</label>
              <input type="text" id="filter-name" name="commercialName">
            </div>
            <div class="form-group">
              <label for="filter-email">NIF:</label>
              <input type="text" id="filter-email" name="vatNumber">
            </div>
